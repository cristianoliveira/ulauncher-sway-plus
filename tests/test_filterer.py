...
class TestFilterer(unittest.TestCase):
    def test_filter_result_list(self):
        ...
        self.assertEqual(
            filtered_result_list.result_list[0].get_description(""),
            "description for first_match",
        )
        self.assertEqual(
            filtered_result_list.result_list[1].get_name(), "first_second_match"
        )
        self.assertEqual(
            filtered_result_list.result_list[1].get_description(""),
